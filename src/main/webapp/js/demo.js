var TEST_SAVVY = {
 ...
 getvisualizationData: function (jsonData) {
  ...
  $.each(jsonData, function (i, obj) {
   ...
   dataArray.push([obj.name, obj.mathematicsMark, TEST_SAVVY.returnTooltip(point1, point2), obj.computerMark, TEST_SAVVY.returnTooltip(point1, point2)]);
  });
 ...
 drawBarChart: function (inputdata) {
  ...
  var barOptions = TEST_SAVVY.getOptionForBarchart(),

   data = TEST_SAVVY.getvisualizationData(inputdata),
